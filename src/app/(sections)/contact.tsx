...
function ContactSection() {
  ...
  return (
    <div className="relative bg-[#0a0a0a] pt-16 md:pt-24 lg:pt-28 grain" ref={ref}>
        ...
        <div className="flex justify-center pb-24 md:pb-32">
          <div className="w-full max-w-2xl">
            <div className="text-center mb-10 md:mb-12">
              ...
              <p className={`text-[#666] text-sm md:text-base mb-10 md:mb-14 ${isVisible ? "animate-fade-in-up delay-200" : "opacity-0"}`}>
                Have a project in mind? Let&apos;s bring it to life.
              </p>
            </div>

            <div className={`flex flex-col gap-6 ${isVisible ? "animate-fade-in-up delay-300" : "opacity-0"}`}>
